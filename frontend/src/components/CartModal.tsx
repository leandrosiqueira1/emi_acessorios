...
// Converte string ou número para número seguro
        ...
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div className="mt-4 flex gap-2">
              <button
                onClick={clearCart}
                className="w-1/3 bg-gray-300 rounded px-3 py-2 hover:opacity-60"
              >
                Limpar
              </button>
              <button
                className="flex-1 bg-violet-600 text-white rounded px-4 py-2 hover:opacity-60"
              >
                Finalizar compra
              </button>
            </div>
